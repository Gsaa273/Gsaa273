<?php
session_start();
$ip_add = getenv("REMOTE_ADDR"); // Get the user's IP address
    ...
    if (mysqli_num_rows($run_query) > 0) {
        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            echo "<div type='button' class='btn navbar-btn selectBrand' bid='$bid'>
                    <a href='#'>$brand_name<small>($count)</small></a>
                  </div>";
        }
        echo "</div>";
    }
...
if (isset($_POST["Common"])) {
    ...
    if (isset($_POST["checkOutDetails"])) {
        if (mysqli_num_rows($query) > 0) {
                    ...
                    <tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-4 "><img src="' . $pro_image . '" style="height: 70px;width:75px;"/>
            ...
            if (!isset($_SESSION["uid"])) {
                echo '
					<a href="" data-toggle="modal" data-target="#Modal_login" class="btn btn-primary"> Login to Checkout Now</a>
					</td>
								</tr>
							</tfoot>
...
<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-primary"
       value="Checkout Now2">
</form></td>
							</tr>
