...
<div class="container-fluid">
    <div class=" text-warning text-center" id="signup_msg">
    ...
    <form id="signup_form" onsubmit="return false" class="login100-form">
        ...
        <div class="form-group">
            ...
            <span>Password Must have at least 1 uppercase letter, 1 lowercase letter, number, and special character, and the minimum length is 8 </span>
        </div>
        <div class="form-group">
